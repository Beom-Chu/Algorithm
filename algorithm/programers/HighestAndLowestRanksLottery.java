 ...
 */
public class HighestAndLowestRanksLottery {
    ...
    public int[] solution(int[] lottos, int[] win_nums) {
        ...
        return new int[]{Math.min(6 ,7 - (matchCount + zeroCount)), Math.min(6 , 7 - matchCount)};
    }
    ...
    public void test() {
        ...
        Assertions.assertArrayEquals(new int[]{6,6}, solution(new int[]{1, 2, 3, 4, 5, 6}, new int[]{7, 8, 9, 10, 11, 12}));
    }
}
