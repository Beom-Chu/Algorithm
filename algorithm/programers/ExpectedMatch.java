...
public class ExpectedMatch {
    ...
    @Test
    public void test() {
        Assertions.assertEquals(3, solution2(8, 4, 7));
        Assertions.assertEquals(1, solution2(2, 1, 2));
        Assertions.assertEquals(4, solution2(16, 1, 16));
        Assertions.assertEquals(1, solution2(16, 15, 16));
        Assertions.assertEquals(2, solution2(16, 13, 16));
        Assertions.assertEquals(3, solution2(8, 4, 5));
    }
}
/*
8 4 7
