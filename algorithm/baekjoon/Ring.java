...
1 초 128 MB  7360  5645  5221  78.748%
문제
...
유클리드호제법으로 첫번째 링과 다음 링들의 최대공약수를 구한 후 나눠줌.
...
class Ring {
  ...
  public static void main(String[] args) throws Exception {
    ...
    int firstRing = Integer.valueOf(token.nextToken());

    for (int i = 1; i < n; i++) {

      int nextRing = Integer.valueOf(token.nextToken());
      int gcd = gcdRecursion(firstRing, nextRing);
