...
1 초	512 MB	2570	1735	1531	69.909%
문제
...
public class MiniGameWithEames {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 중복 제거 참여자 / (참여 게임 정원 - 1[임스])
        System.out.println(players.size() / (game.equals("Y") ? 1 : (game.equals("F") ? 2 : 3)));
    }
}
