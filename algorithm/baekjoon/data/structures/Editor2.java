...
0.3 초 (하단 참고)	512 MB	119387	33248	22339	26.576%
문제
...
public class Editor2 {
    ...
    static ListIterator<Character> textIterator;

    // System.in.read() 사용으로 속도 개선
    public static void main(String[] args) throws IOException {
        BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(System.out));

        List<Character> textList = readCharacterList();
        textIterator = textList.listIterator(textList.size());
        int m = readInt();
    ...
    private static void execute(char command) throws IOException {

        switch (command) {
            case 'L':
                if (textIterator.hasPrevious()) {
    ...
    public static List<Character> readCharacterList() throws IOException {
